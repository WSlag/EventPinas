...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display-xl': ['2.25rem',  { lineHeight: '2.625rem', letterSpacing: '-0.03em',  fontWeight: '800' }],
        'display-lg': ['1.875rem', { lineHeight: '2.25rem',  letterSpacing: '-0.025em', fontWeight: '800' }],
        'heading-xl': ['1.5rem',   { lineHeight: '1.875rem', letterSpacing: '-0.02em',  fontWeight: '700' }],
        'heading-lg': ['1.25rem',  { lineHeight: '1.625rem', letterSpacing: '-0.015em', fontWeight: '700' }],
        'heading-md': ['1.125rem', { lineHeight: '1.5rem',   letterSpacing: '-0.01em',  fontWeight: '600' }],
        'heading-sm': ['1rem',     { lineHeight: '1.5rem',   letterSpacing: '-0.005em', fontWeight: '600' }],
